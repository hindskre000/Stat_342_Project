...
```   
# Statistical Methods
begin with defining the random variable and your statistical model, define the parameter of interest and then describe at least two different approaches you will use to make inference about it. 
...
**Bootstrapping**
```{r bootstrapping, no mom formula, echo = FALSE}
B = 1000
set.seed(1234)
boot_df_2 <- tibble(
